...
<div class="amin-section container">
      <H1>Gestion des Chapitres</H1><a href="/admin/page-insert.html" title="Ajouter une page">Ajouter un chapitre</a> 
...

      {
        ...
        <tr>
         <td scope="row"><?= $i; ?></td>
         <td scope="row"><a href="/posts-<?= $pages['id']; ?>.html" title=""><?= $pages['menu']; ?></a></td>
