 ...
 */
 ...
 <section id="works"></section>
  ...
  <?php
  foreach ($listeChapitres as $listeChapitre)
  {
      ?>
      <h3><a href="posts-<?= $listeChapitre['id'] ?>.html"><?= $listeChapitre['menu'] ?></a></h3>
      <p><?= nl2br($listeChapitre['content']) ?></p>
      <a href="posts-<?= $listeChapitre['id'] ?>.html">Lire la suite...</a>
      <?php
  }
  ?>
